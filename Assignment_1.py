...
height_1 = input("Enter height : ")
height_2 = input("Enter height : ")
height_3 = input("Enter height : ")
height_4 = input("Enter height : ")
height_5 = input("Enter height : ")
height_6 = input("Enter height : ")
height_7 = input("Enter height : ")
height_8 = input("Enter height : ")
height_9 = input("Enter height : ")
height_10 = input("Enter height : ")
...
print("\n\n\t\t\tThe avarage height for the 10 students is = " + str(avarage))